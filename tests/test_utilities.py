...
def test_100x_model():
    ...
    # test data creation
    create_data(
        None, tumor_bam, normal_bam, "example", ms_list, vector_folder, False, 50, 16
    )
    ...
    assert os.path.isfile("./example/example_results.npy")
    assert os.path.isfile("./example/example_results.txt")
...
def test_200x_model():
    ...
    # test data creation
    create_data(
        None, tumor_bam, normal_bam, "example", ms_list, vector_folder, False, 100, 16
    )
